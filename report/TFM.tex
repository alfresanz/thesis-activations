...
\title{Title}   		           % Master thesis title
\author{Name Surname1 Surname2}    % Name and surnames of the student
\supervisor{Name Surname1 Surname2} % Name and surnames of the director/advisor
\ponente{Name Surname1 Surname2}   % Name and surnames of the ponente/lecturer (only if applicable)
\date{MONTH 202X}
